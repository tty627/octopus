...
describe("research pack workflows", () => {
  ...
  it("exports the research ZIP without originals by default", async () => {
    ...
    const taskExport = vi.spyOn(api, "taskExport").mockResolvedValue(new Blob(["pack"], { type: "application/zip" }));
    ...
    await waitFor(() => expect(taskExport).toHaveBeenCalledWith(activeTask, { citation_style: "gb-t-7714-2015", include_sources: false }));
